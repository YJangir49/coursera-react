...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.firstname && firstname.length<3 )
            ...
            error.firstname = "First Name can contains atmost 10 charchters";

        if(this.state.touched.lastname && lastname.length<3 )
            error.lastname = "Last Name must contains atleast 3 charchters";
        
        else if(this.state.touched.lastname && lastname.length>10 )
            error.lastname = "Last Name can contains atmost 10 charchters";
        
        const reg= /^\d+$/ ;
        if(this.state.touched.telnum && !reg.test(telnum))
            error.telnum=" Telnumber should contains numeric value only";

        if(this.state.touched.email && email.split('').filter((x)=> x === '@').length !==1)
            error.email="Please Enter a valid email. Email should contains '@' ";
                        ...
                        <div className="col-12 col-md-9">
                            <Form onSubmit={this.handleSubmit}>
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input type="tel" id="telnum" name="telnum"  placeholder="Contact Tel. Number" value={this.state.telnum}
